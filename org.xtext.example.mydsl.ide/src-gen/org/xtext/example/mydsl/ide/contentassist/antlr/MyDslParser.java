...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getServerAccess().getAlternatives(), "rule__Server__Alternatives");
			builder.put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
			builder.put(grammarAccess.getRuleAccess().getGroup(), "rule__Rule__Group__0");
			builder.put(grammarAccess.getFromAccess().getGroup(), "rule__From__Group__0");
			builder.put(grammarAccess.getToAccess().getGroup(), "rule__To__Group__0");
			...
			builder.put(grammarAccess.getModelAccess().getRulesAssignment_0(), "rule__Model__RulesAssignment_0");
			...
			builder.put(grammarAccess.getRuleAccess().getFromAssignment_2(), "rule__Rule__FromAssignment_2");
			builder.put(grammarAccess.getRuleAccess().getToAssignment_3(), "rule__Rule__ToAssignment_3");
			builder.put(grammarAccess.getFromAccess().getServerAssignment_1(), "rule__From__ServerAssignment_1");
			builder.put(grammarAccess.getToAccess().getServerAssignment_1(), "rule__To__ServerAssignment_1");
