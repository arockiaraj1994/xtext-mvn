...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  private EEnum serverEEnum = null;
   ...
   * @generated
   */
  public EAttribute getFrom_Server()
  {
   ...
   * @generated
   */
  public EAttribute getTo_Server()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(fromEClass, FROM__SERVER);

    toEClass = createEClass(TO);
    createEAttribute(toEClass, TO__SERVER);

    // Create enums
    serverEEnum = createEEnum(SERVER);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getRule_From(), this.getFrom(), null, "from", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRule_To(), this.getTo(), null, "to", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(fromEClass, From.class, "From", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFrom_Server(), this.getServer(), "server", null, 0, 1, From.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(toEClass, To.class, "To", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTo_Server(), this.getServer(), "server", null, 0, 1, To.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    // Initialize enums and add enum literals
    initEEnum(serverEEnum, Server.class, "Server");
    addEEnumLiteral(serverEEnum, Server.SFTP);
    addEEnumLiteral(serverEEnum, Server.ACTIVE_MQ);
